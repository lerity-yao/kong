...
local function get_node_info(self, dao, helpers)
...
return {
  -- Root endpoint: GET / → node info (including plugins.available_on_server)
  ["/"] = {
    GET = get_node_info,
  },
  -- /kong endpoint: same as root, needed by @kong-ui-public/entities-plugins
  -- Enterprise Kong: /{workspace}/kong works via workspace routing middleware
  -- OSS Kong: /workspaces/:workspaces/kong generated by init.lua workspace prefix logic
  ["/kong"] = {
    GET = get_node_info,
  },
  ["/endpoints"] = {
